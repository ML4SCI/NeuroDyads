# How to run the script to study the gender differences 

## Step 1: Make an account on Kaggle and validate it to access GPU resources 

## Step 2: Upload the notebook from Github to your Kaggle account 
...
3. You also have to upload montage file to kaggle to the same place 

## Step 4: You choose the GPU Accelerator 
